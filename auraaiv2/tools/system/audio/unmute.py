"""Tool: system.audio.unmute - Delegates to root utils.windows_system (SINGLE OS BOUNDARY)."""
...
class Unmute(Tool):
    """Unmute system audio via root windows_system only."""
    ...
    def execute(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        ok = _WSU.unmute_system_volume()
        return {"status": "success" if ok else "error", "is_muted": False}
